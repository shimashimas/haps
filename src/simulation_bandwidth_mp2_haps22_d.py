...
# ---- IO Settings ----
OUTPUT_DIR_BASE = r"Result\BatchRun\4\disaster\p120"
OUT_ENABLE = True
OUT_MAKE_DIR = True
OUT_PRINT = True
OUT_CSV_RUNLOG = True
...
if __name__ == "__main__":
    ...
    storage_sinr = {}
    base_path = r"database\beamlist_disaster"
    scenarios = [
        (1.0,  os.path.join(base_path, "HAPS_beamlist_r1km_p1.2_disaster_cx21_cy25_r18.csv")),
        (2.0,  os.path.join(base_path, "HAPS_beamlist_r2km_p1.2_disaster_cx21_cy25_r18.csv")),
        (3.0,  os.path.join(base_path, "HAPS_beamlist_r3km_p1.2_disaster_cx21_cy25_r18.csv")),
    ]
